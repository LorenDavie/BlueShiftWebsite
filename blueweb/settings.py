"""
Django settings for blueweb project.
...
SECRET_KEY = 'h6a0kr9vi!6a4oacichnhe!3v)h&wd@7&en6-hdhs3e==(c30h'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True if os.environ.get('BLUESHIFT_DEBUG', None) else False

ALLOWED_HOSTS = ['www.blueshift.band', 'blueshift-band.herokuapp.com', 'localhost']
...
WSGI_APPLICATION = 'blueweb.wsgi.application'
